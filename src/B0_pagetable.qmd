...
- We now making page table frames accessible to our kernel.
...
- Page table pointers are physical, not virtually, to avoid recursive look-ups
...
- Also, at least I don't have that much storage so - no collisions!
