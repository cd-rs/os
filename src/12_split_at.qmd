...
- [Calling an Unsafe Function or Method](https://raw.githubusercontent.com/rust-lang/book/refs/heads/main/src/ch20-01-unsafe-rust.md)
...
- Create a crate which:
	...
	- Abstracts all `unsafe` blocks to `lib.rs` but successful calls unsafe code from `main.rs`
